...
$row2 = mysql_fetch_array($result2, MYSQL_ASSOC);
		...
		echo "<h1 align='center' style='width:100%; height:50px; top: -22px; position: relative; color:white;font-weight:initial; font-size: 34px; background:-webkit-linear-gradient(#0078c3 0%, #ffffff 160%); line-height:1.5'>DELETE A STUDENT</h1>";
		...
		echo "<br/>";
		echo "<input type='text' class='textbox' name='code' style='text-transform: uppercase;' placeholder='Subject Code' maxlength='10'>";
				echo "<br/>";
		echo "<input type='submit' class='butt' value='Delete'/>";
		echo "</form>";
		echo "</div>";
?>
</body>
